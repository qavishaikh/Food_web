...
function viewCategory() {
    ...
    dbref.get()
      ...
      <td class='th-1'>
      <button class='btn btn-danger ed-btn' id='${dataValue[i]["categoryKey"]}' onclick="DeletCategory(this)">Delete</button>
      <button class='btn btn-success ed-btn' data-bs-toggle="modal" data-bs-target="#exampleModal" id='${dataValue[i]["categoryKey"]}' onclick="EditFunctionText(this)">Edit</button>
